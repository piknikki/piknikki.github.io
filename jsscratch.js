...
class Admin extends User {
    ...
    authorizeAccess() {
        ...
        console.log(`${this.firstName}'s admin level is:  ${this.adminLevel}`)
    }
}

// Create a new isntance of the Admin class, pass in all the necessary properties
let nikki = new Admin("Nikki", "Petersen", 29, "excited", "Super User", "Developer")


// Call the authorizeAccess method on the Admin class

nikki.authorizeAccess();
